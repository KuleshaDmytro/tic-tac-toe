    ...
    return(
        <main className='aboutUs_micro_container ourMission_container'>
            {/* <div className='aboutUs_card'> */}
                <div className='ourMission aboutUs aboutUs_retreat'>
                ...
                <div className="ourMissionImg aboutUsImg  aboutUs_retreat">

                    <div className='img_ourMission img_size_aboutUs'></div>
