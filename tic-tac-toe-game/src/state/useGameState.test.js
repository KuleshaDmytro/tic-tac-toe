...
import { useGameState } from './useGameState'; // Підставте правильний шлях до вашого хука
...
//  ???
    ...
    expect(result.current.matrix[1][0]).toBe(0);
    ...
    expect(result.current.matrix[0][1]).toBe(2);
    ...
    expect(result.current.matrix[0][2]).toBe(0);
